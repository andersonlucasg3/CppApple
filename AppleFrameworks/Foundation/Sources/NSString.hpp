...
namespace Private
{
    ...
    namespace Selector
    {
        _NS_PRIVATE_DEF_SEL(stringByResolvingSymlinksInPath,
...
_NS_INLINE NS::String* NS::String::stringByResolvingSymlinksInPath() const
{
    return Object::sendMessage<NS::String*>(this, _NS_PRIVATE_SEL(stringByResolvingSymlinksInPath));
}
